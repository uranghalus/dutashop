...
import { RiAlarmWarningLine, RiAlertLine, RiCheckboxCircleLine, RiInformationLine, RiLoader2Line } from '@remixicon/react'
                ...
                icons={{
                    success: (
                        <div className={`${iconWrapper} bg-[#008a63] text-background`}>
                            <RiCheckboxCircleLine className="size-6 sm:size-6" />
                        </div>
                    ),
                    warning: (
                        <div className={`${iconWrapper} bg-[#ffc864] text-foreground`}>
                            <RiAlertLine className="size-6 sm:size-6" />
                        </div>
                    ),
                    error: (
                        <div className={`${iconWrapper} bg-[#ec486a] text-background`}>
                            <RiAlarmWarningLine className="size-6 sm:size-6" />
                        </div>
                    ),
                    info: (
                        <div className={`${iconWrapper} bg-[#3b82f6] text-background`}>
                            <RiInformationLine className="size-6 sm:size-6" />
                        </div>
                    ),
                    loading: (
                        <div
                        ...
                        >
                            <RiLoader2Line className="size-6 sm:size-6 animate-spin" />
                        </div>
                    ),
                }}
            />
